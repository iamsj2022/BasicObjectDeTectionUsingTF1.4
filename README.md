### BasicObjectDeTectionUsingTF1.4


Actually I have Used Pretrained Model Inception v2 + FasterRCNN for Object detection using TensorFlow==1.14 version for 2 datasets-->> 1.Normal OD 2.Card Prediction

I have Trained the model for only 468 steps in my local enviroment and then used that model checkpoint to predict the datasets.
...
https://www.dropbox.com/s/7dlmk35e4m0ww4b/utils.zip?dl=0 ### Dataset & utils Download
